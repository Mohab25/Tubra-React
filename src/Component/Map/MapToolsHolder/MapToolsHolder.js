...
export default function MapToolsHolder(props) {
    ...
    return (
        <div>
            <ToolsPane toggleWindowVisibility={toggleWindowVisibility} toggleLinearMeasurement={props.toggleLinearMeasurement} distance={props.distance} activateVector={props.activateVector} isVectorActivated={props.isVectorActivated} createPoint={props.createPoint}/>
